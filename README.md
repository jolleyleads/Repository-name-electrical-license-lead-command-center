# Repository-name-electrical-license-lead-command-center
...
git clone https://github.com/jolleyleads/Repository-name-electrical-license-lead-command-center.git
cd Repository-name-electrical-license-lead-command-center
python -m venv venv
